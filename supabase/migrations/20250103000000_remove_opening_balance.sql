/*
  # Remove Opening Balance Feature
  
  This migration removes the opening_balance columns from customers and vendors tables
  and updates the balance calculation logic to work without opening balances.
*/

-- Remove opening_balance columns from customers and vendors tables
ALTER TABLE customers DROP COLUMN IF EXISTS opening_balance;
ALTER TABLE vendors DROP COLUMN IF EXISTS opening_balance;

-- Update the balance calculation functions to work without opening balance
...
-- Clear existing data and add fresh demo data without opening balance
...
-- Insert fresh demo data without opening balance
